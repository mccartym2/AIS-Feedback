...
# in the folder, we have C or ASM files:
...
orig_ASM_dir = '/home/ubuntu/courses/691/riscv-malware-analysis/malware_asm-orig'
nop_ASM_dir = '/home/ubuntu/courses/691/riscv-malware-analysis/malware_asm-nop'
binary_ASM_dir = '/home/ubuntu/courses/691/riscv-malware-analysis/malware_asm-binary'
...
def main():
	...
	for file_path in Path(nop_ASM_dir).rglob('*.asm'):
		...
		while flag and flag_do_2nd_pass:
			...
			os.system('java -jar /home/ubuntu/courses/691/riscv-malware-analysis/rars_2eb7c66.jar' + ' a dump .text BinaryText ' + binary_text_file + ' ' + nop_asm_file_name + ' & > rars_log.txt')
