...
if malware_flag:
	orig_ASM_dir = '/home/risvc/riscv-malware-analysis/malware_asm-orig'
	nop_ASM_dir = '/home/risvc/riscv-malware-analysis/malware_asm-nop'
	binary_ASM_dir = '/home/risvc/riscv-malware-analysis/malware_asm-binary'
	source_dir = '/home/riscv/Linux_VX'	
else:
...
def main():
	...
	for file_path in Path(source_dir).rglob('*.c'):
		...
		os.system(str('riscv64-unknown-linux-gnu-gcc -march=rv32ima -mabi=ilp32 -O0 -S "' + str(file_path) + '" -o "' + str(asm_file_name) + '"'))
